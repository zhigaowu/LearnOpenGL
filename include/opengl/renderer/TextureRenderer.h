#ifndef _OPENGL_RENDERER_TEXTURE_RENDERER_HEADER_H_
#define _OPENGL_RENDERER_TEXTURE_RENDERER_HEADER_H_
    ...
    namespace renderer {
        ...
        public:
            TextureRenderer() 
                ...
                , _uniform_light_position(-1), _uniform_light_direction(-1)
...
#pragma warning(disable: 4312)
                if (-1 == _uniform_object_color)
                {
                    ...
                    do
                    {
                        ...
                        if (!vshader.Compile("#version 330 core                                      \n"
                            ...
                            "layout (location = 2) in vec2 vec2_texture_position;                    \n"
                            "                                                                        \n"
                            "uniform mat4 model;                                                     \n"
                            "uniform mat4 view;                                                      \n"
                            ...
                            "   vec2_sample_position = vec2_texture_position;                        \n"
                        ...
                        if (!fshader.Compile("#version 330 core                  \n"
                            ...
                            "       FragColor = vec4((light_parameter.ambient * texture(object_material.diffuse, vec2_sample_position)).rgb, vec4_uniform_object_color.w);\n"
                            "   } else {                                                                                                         \n"
                            "       vec4 vect4_texture_sample_color = texture(object_material.diffuse, vec2_sample_position);                        \n"
                            "       vec4 vec4_ambient = light_parameter.ambient * vect4_texture_sample_color;                                        \n"
                            "                                                                                                                        \n"
                            "       vec3 vec3_norm = normalize(vec3_uniform_normal);                                                                 \n"
                            "       float float_diff = max(dot(vec3_norm, vec3_light_direction), 0.0);                                               \n"
                            "       vec4 vec4_diffuse = light_parameter.diffuse * (float_diff * vect4_texture_sample_color);                         \n"
                            "                                                                                                                        \n"
                            ...
                            "       vec4 vect4_specular_sample_color = texture(object_material.specular, vec2_sample_position);                      \n"
                            "       vec4 vec4_specular = light_parameter.specular * float_spec * vect4_specular_sample_color;                        \n"
                            "                                                                                                                        \n"
            ...
            void Render(const GeometryType& geometry_object, const opengl::material::TextureMaterial& object_texture, const LightType& light, const opengl::scene::LightParameter& light_parameter, const opengl::scene::Camera& camera)
            {
                if (geometry_object.visible)
                {
                    object_texture.Activate();
                    ...
                    opengl::core::Uniform::Set<GLint>(_uniform_object_material.diffuse, std::vector<GLint>{static_cast<GLint>(object_texture.diffuse_unit - GL_TEXTURE0)});
                    opengl::core::Uniform::Set<GLint>(_uniform_object_material.specular, std::vector<GLint>{static_cast<GLint>(object_texture.specular_unit - GL_TEXTURE0)});
                    opengl::core::Uniform::Set<GLfloat>(_uniform_object_material.shininess, std::vector<GLfloat>{object_texture.shininess});
